...
You will need to download this dataset: [WolfCounts2024.csv](WolfCounts2024.csv), which has seven columns: `Year` and then six more representing the TOTAL counts from the 6 biologists that monitored the human-wolf population.  They are: Alissa, Eli, Bruce, Randi, Raymond and Manny.
...
Load the dataset, and select **one** of the six sets of observations.  Plot that curve, and comment on its shape, i.e. does it look (a) linear, (b) exponential, (c) sigmoidal or something else? 
