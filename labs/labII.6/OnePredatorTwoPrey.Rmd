...
The model is a **Lotka-Volterra predation model**, but with **two prey species** and some prey carrying capacity.  There is no **direct** competion between the prey, as caribou and moose use very different kinds of habitat. 
...
> 
> *Note, you could, in theory, solve for this without guess-and-checking by finding where the (vertical) predator isocline intercepts with the (slanty) prey isocoline, but then you'd be doing algebra.*
