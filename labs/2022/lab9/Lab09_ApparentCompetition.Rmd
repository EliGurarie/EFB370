...
> <font color = "blue"> **Harder Exercise 2:** Let's say it took 10 years for the first wolves to arrive. So, your starting parameters should now be the number of caribou from the previous exercise and some starting amount of wolves (generally, you would want 2 to have a start for the population...). After some time, they attained a steady equilibrium of 30 animals in the area, while cutting down the caribou population to 400.  Simulate this process - what parameters and how many years does it take to achieve that goal?  In the process, figure out what the value of the predator mortality parameter ($\sigma_c$) must be to obtain these steady states.</font>  <font color = "green">*Note, you could, in theory, solve for this without guess-and-checking by finding where the (vertical) predator isocline intercepts with the (slanty) prey isocoline, but then you'd be doing algebra.*</font> 
