...
> # Lab Exercise 2
>
> In the next homework assignment (due next Thursday, March 2) you will be asked to analyze the population growth rate of sea otters in British Columbia, the population just to the north of Washington state.  Now is your chance to (1) Load the data, (2) plot the data, and (3) summarize the data (how many were released, in what year, how many are there in the final year of data). 
>
>In the homework, you will estimate the growth rate with confidence intervals as well.  For for the lab exercise, just provide the plot and the summary. 
