...
The columns are: `Species`, `Day` of experiment, `Nt` - number (or density) of paramecium now, `Nt1` - number one time step previous $\Delta N_{t-1}$, and $r$ - per-capita growth rate, i.e. $\Delta N_t/N_t$.  
