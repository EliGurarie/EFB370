...
author: "Elie Gurarie and Nate Wehr  (borrowing HEAVILY from Owens)"
date: "`r Sys.Date()`"
output: 
  html_document: 
    toc: true
...
> This lab was developed by [Prof. Owen Jones](https://www.transmittingscience.com/instructors/owen-r-jones/) as part of a [course similar to ours](https://jonesor.github.io/BB512_Book/) taught at Odense University in Denmark. 
