...
The assignment operator is `<-`. It's supposed to look like an arrow pointing left (the shortcut for entering it is `Alt` and `-`).
...
> Plot the `myseaotter` data frame you download through.... 

Meaning plotting the year column against count column  
