...
author: "Nate Wehr, Ekaterina Khadonova and Elie Gurarie"
date: "`r Sys.Date()`"
output: 
  html_document: 
    toc: true
...
> There are THREE exercises in this lab to submit by midnight next Monday, March 6.  
...
>
> After facial tumor disease emerged and established itself in the Tasmanian devil population,  the mortality of 2 year olds and 3 year olds skyrocketed to 90%. This had an immediate impact on the population growth rate.  One way the population responsed was by increasing "precocial" births, i.e. 1 yr olds (and 2 year olds) that reproduced. How high must birth rate become to maintain the Tasmanian devil population? 
