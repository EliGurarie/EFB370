---
title: 'Charismatic Competition'
subtitle: '[EFB 370](https://eligurarie.github.io/EFB370/) - Spring 2026'
author: "Elie Gurarie"
date: "`r Sys.Date()`"
output: 
  html_document: 
...
> 3. There are **5** exercises in this lab to submit by midnight, Friday March 28.   
...
There are two datasets posted on Blackboard or at these links: [`single.csv`](single.csv) and [`mixture.csv`](mixture.csv)
...
$${dN_1 \over dt} = r_1 N_1 \left(1-{N_1 \over K_1} - \alpha {N_2\over K_1}\right)$$
$${dN_2 \over dt} = r_2 N_2 \left(1-{N_2 \over K_2} - \beta { N_1\over K_2}\right)$$
...
How close can you get your $R^2$ values to 1?  
