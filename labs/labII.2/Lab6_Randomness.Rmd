...
**HERE** An alternative way to import data is by going to `File>Import Dataset>From Text (base)` and navigate to the the files in your library (they are probably in your downloads). Then click `Import`. 
