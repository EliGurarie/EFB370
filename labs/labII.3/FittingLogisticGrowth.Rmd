...
> There are THREE exercises in this lab to submit by **midnight Friday, Feb 28**.  
...
>  Generate a plot of this fit of logistic growth over time on top of the paramecium data by using exactly the code in Exercise 1, but plugging in the estimates for $K$ and $r_0$. You'll have to put in your own guess for $N_0$ (the initial population size).  What is that guess? 
...
```{r}
myfit <- nls(Nt ~ N.logistic(Day, N0, K, r0), data = paramecium, 
    start = list(N0 = 1, K = 200, r0 = 0.75))
