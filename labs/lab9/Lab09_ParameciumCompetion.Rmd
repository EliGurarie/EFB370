...
> 3. There are **XX** exercises in this lab to submit by midnight next Monday, April 3.   
...
There are two datasets posted on Blackboard and [here](data):  `single.csv` and `mixture.csv`.  
