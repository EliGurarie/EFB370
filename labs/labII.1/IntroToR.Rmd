---
title: "Introduction to R and Linear Models for Exponential Growth"
subtitle: 'EFB 370: Recitation II.1'
author: "Dr. Gurarie and Kate Henderson"
date: "`r Sys.Date()`"
output: 
...
Link to download R Studio: https://posit.co/download/rstudio-desktop/
...
This dataset is available on **Blackboard** as `SeaLions.csv`, or at [this link](SeaLions.csv).   Once you download it, you can use the File Explorer to determine its location and read it into R in a couple of ways:
...
> The first step is to import our new dataset. It is called `SeaOtters.csv` and is [here](SeaOtters.csv) or on [Blackboard](https://blackboard.syracuse.edu/ultra/courses/_492502_1/cl/outline).  Plot the downloaded data, using the "Year" column on the X-axis and "Count" column on the y-axis.  For this exercise **provide the plotting code**. 
